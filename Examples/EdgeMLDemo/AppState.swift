...
/// Shared application state for the EdgeML pilot reference app.
///
...
class AppState: ObservableObject {
    ...
    ///
    /// The EdgeML CLI (`edgeml deploy --phone`) discovers devices through
...
enum AppTab: Hashable {
    ...
    case demo
    /// The paired model tab (shows `TryItOutScreen` after `edgeml deploy --phone`).
    case paired
}
