...
/// conformance to ``ModelCaching``. We cannot easily construct ``OctomilModel``
...
final class ModelCacheTests: XCTestCase {
    ...
    func testMockStoreAndGet() {
        ...
        let model = FakeOctomilModel(id: "m1", version: "1.0.0")
    ...
    func testMockGetReturnsNilForMissingVersion() {
        let mock = MockModelCachingImpl()
        mock.storeFake(FakeOctomilModel(id: "m1", version: "1.0.0"))
    ...
    func testMockGetLatestReturnsHighestVersion() {
        ...
        mock.storeFake(FakeOctomilModel(id: "m1", version: "1.0.0"))
        mock.storeFake(FakeOctomilModel(id: "m1", version: "2.0.0"))
        mock.storeFake(FakeOctomilModel(id: "m1", version: "1.5.0"))
    ...
    func testMockGetLatestSingleVersion() {
        let mock = MockModelCachingImpl()
        mock.storeFake(FakeOctomilModel(id: "m1", version: "3.1.4"))
        let latest = mock.getLatestFake(modelId: "m1")
    ...
    func testMockClearAllRemovesEverything() throws {
        let mock = MockModelCachingImpl()
        mock.storeFake(FakeOctomilModel(id: "m1", version: "1.0.0"))
        mock.storeFake(FakeOctomilModel(id: "m2", version: "1.0.0"))
    ...
    func testMockDifferentModelsIsolated() {
        let mock = MockModelCachingImpl()
        mock.storeFake(FakeOctomilModel(id: "alpha", version: "1.0.0"))
        mock.storeFake(FakeOctomilModel(id: "beta", version: "2.0.0"))
    ...
    func testMockVersionComparisonSemantic() {
        let mock = MockModelCachingImpl()
        mock.storeFake(FakeOctomilModel(id: "m", version: "1.9.0"))
        mock.storeFake(FakeOctomilModel(id: "m", version: "1.10.0"))
        mock.storeFake(FakeOctomilModel(id: "m", version: "2.0.0"))
    ...
    func testMockVersionComparisonDifferentPartCounts() {
        let mock = MockModelCachingImpl()
        mock.storeFake(FakeOctomilModel(id: "m", version: "1.0"))
        mock.storeFake(FakeOctomilModel(id: "m", version: "1.0.1"))
...
// MARK: - Fake OctomilModel wrapper

/// Lightweight stand-in for ``OctomilModel`` identity properties.
/// Used with ``MockModelCachingImpl`` to avoid needing real ``MLModel``s.
private struct FakeOctomilModel {
    let id: String
    let version: String
}
...
private final class MockModelCachingImpl: ModelCaching, @unchecked Sendable {
    private var models: [String: OctomilModel] = [:]
    private var fakes: [String: FakeOctomilModel] = [:]

    var currentSize: UInt64 { 0 }

    func get(modelId _: String, version _: String) -> OctomilModel? {
        // Only check fake store for these tests
        return nil
    }

    func getLatest(modelId _: String) -> OctomilModel? {
        return nil
    }

    func store(_ _: OctomilModel) {
        // Can't be used without real OctomilModel
    }
    ...
    func storeFake(_ fake: FakeOctomilModel) {
        let key = "\(fake.id)_\(fake.version)"
        fakes[key] = fake
    }

    func getFake(modelId: String, version: String) -> FakeOctomilModel? {
        return fakes["\(modelId)_\(version)"]
    }

    func getLatestFake(modelId: String) -> FakeOctomilModel? {
