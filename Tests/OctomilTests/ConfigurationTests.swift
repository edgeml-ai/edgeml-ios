...
final class ConfigurationTests: XCTestCase {
    ...
    func testDefaultConfiguration() {
        let config = OctomilConfiguration.standard
    ...
    func testDevelopmentConfiguration() {
        let config = OctomilConfiguration.development
    ...
    func testProductionConfiguration() {
        let config = OctomilConfiguration.production
    ...
    func testLogLevelOrdering() {
        XCTAssertTrue(OctomilConfiguration.LogLevel.none.rawValue < OctomilConfiguration.LogLevel.error.rawValue)
        XCTAssertTrue(OctomilConfiguration.LogLevel.error.rawValue < OctomilConfiguration.LogLevel.warning.rawValue)
        XCTAssertTrue(OctomilConfiguration.LogLevel.warning.rawValue < OctomilConfiguration.LogLevel.info.rawValue)
        XCTAssertTrue(OctomilConfiguration.LogLevel.info.rawValue < OctomilConfiguration.LogLevel.debug.rawValue)
        XCTAssertTrue(OctomilConfiguration.LogLevel.debug.rawValue < OctomilConfiguration.LogLevel.verbose.rawValue)
    }

    // MARK: - Sub-Struct Tests

    func testNetworkPolicyDefaults() {
        let policy = OctomilConfiguration.NetworkPolicy()
    ...
    func testLoggingPolicyDefaults() {
        let policy = OctomilConfiguration.LoggingPolicy()
    ...
    func testDevelopmentIsMorePermissiveThanProduction() {
        let dev = OctomilConfiguration.development
        let prod = OctomilConfiguration.production
    ...
    func testDevelopmentHasLoggingEnabled() {
        XCTAssertTrue(OctomilConfiguration.development.enableLogging)
        XCTAssertEqual(OctomilConfiguration.development.logLevel, .debug)
    }

    func testProductionHasLoggingDisabled() {
        XCTAssertFalse(OctomilConfiguration.production.enableLogging)
        XCTAssertEqual(OctomilConfiguration.production.logLevel, .error)
    }
