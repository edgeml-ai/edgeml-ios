...
public final class BackgroundSync: @unchecked Sendable {
    ...
    public static let trainingTaskIdentifier = "ai.edgeml.training"

    /// Background task identifier for model sync.
    public static let syncTaskIdentifier = "ai.edgeml.sync"
    ...
    private weak var client: EdgeMLClient?
    ...
    private init() {
        self.logger = Logger(subsystem: "ai.edgeml.sdk", category: "BackgroundSync")
    }
