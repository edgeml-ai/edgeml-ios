...
/// Handles the end-to-end pairing flow triggered by an `edgeml://pair` deep link.
///
...
///     defaultServerURL: URL(string: "https://api.edgeml.io")!
/// )
///
...
public actor DeepLinkPairingHandler {
    ...
    public init(
        ...
        self.logger = Logger(subsystem: "ai.edgeml.sdk", category: "DeepLinkPairingHandler")
    }
    ...
    /// - Returns: A `Result` if the URL was an `edgeml://` deep link, or `nil`.
...
/// Errors that can occur when handling an `edgeml://` deep link.
