...
/// Monitors network connectivity for the Octomil SDK.
public final class NetworkMonitor: @unchecked Sendable {
    ...
    private init() {
        ...
        self.queue = DispatchQueue(label: "ai.octomil.networkmonitor")
        self.logger = Logger(subsystem: "ai.octomil.sdk", category: "NetworkMonitor")
