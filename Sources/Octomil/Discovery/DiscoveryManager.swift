...
///
/// When discoverable, the Octomil CLI (`octomil deploy --phone`) can find this
...
public final class DiscoveryManager: @unchecked Sendable {
    ...
    public init() {
        self.logger = Logger(subsystem: "ai.octomil.sdk", category: "DiscoveryManager")
    }
    ...
    ///
    /// Creates a ``BonjourAdvertiser`` and begins advertising an `_octomil._tcp`
    /// Bonjour service. The Octomil CLI will be able to find this device by
