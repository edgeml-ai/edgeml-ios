...
public class DeviceMetadata {
    ...
    ///
    /// - Returns: Device profile key (e.g. "REDACTED_DEVICE", "REDACTED_DEVICE").
    public var deviceProfile: String {
        let model = self.model.lowercased()

        // iPhone 15 Pro / Pro Max (A17 Pro, 8GB)
        // Machine IDs: REDACTED_MACHINE_ID (15 Pro) REDACTED_MACHINE_ID (15 Pro Max)
        ...
        // iPhone 16 / 16 Plus (A18, 8GB) — still map to REDACTED_DEVICE tier for non-Pro
